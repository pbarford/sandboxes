    ...
    (m1.keySet ++ m2.keySet) map {
      i => i -> {
        ...
        (m1.get(i), m2.get(i)) match {
          case (Some(i1:List[Map[K,Any]]), Some(i2:List[Map[K,Any]])) => i1.zip(i2) map { e => merge(e._1, e._2) }
